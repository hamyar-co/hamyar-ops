        ...
        <div className="space-y-4">
          <div className="bg-surface border border-border rounded-xl overflow-hidden">
            ...
            <div className="p-4">
              ...
              {!targetsLoading && (
                <pre className="p-4 rounded-lg bg-surface-2/90 border border-border text-xs font-mono text-foreground overflow-x-auto whitespace-pre">
          ...
          <div className="bg-surface border border-border rounded-xl p-4 space-y-2">
            ...
            <pre className="p-3 rounded-lg bg-surface-2/90 border border-border text-xs font-mono text-muted-foreground overflow-x-auto">
              {`scrape_configs:
