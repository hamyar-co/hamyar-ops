      ...
      <div className="bg-surface border border-border rounded-xl shadow-xl w-full max-w-lg space-y-4 p-6">
        ...
        <div>
          ...
          <textarea
            ...
            rows={4}
            className="w-full px-3 py-2 text-xs font-mono rounded-lg bg-surface-2/90 border border-border text-foreground"
          />
      ...
      <div className="bg-surface border border-border rounded-xl shadow-xl w-full max-w-2xl space-y-4 p-6">
        ...
        <div className="grid grid-cols-1 gap-3">
          ...
          <textarea
            ...
            placeholder="---&#10;- name: My playbook&#10;  hosts: all&#10;  tasks: []"
            rows={16}
            className="w-full px-3 py-2 text-xs font-mono rounded-lg bg-surface-2/90 border border-border text-foreground placeholder:text-muted-foreground"
          />
        </div>
...
function LogPanel({
  ...
  return (
    <div className="mt-2 bg-background/80 backdrop-blur-sm rounded-lg border border-border p-3 max-h-80 overflow-y-auto">
      {lines.length === 0 && (
